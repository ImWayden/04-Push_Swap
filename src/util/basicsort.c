...
/*   Updated: 2023/03/28 00:07:21 by therodri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_moves	get_instructions(t_stack *a, t_stack *b, int index_a,
		int index_b)
{
	t_moves	move;
	...
	move.mincost = ft_min(4, move.ra_rb + move.nb_rr, move.rra_rrb
			+ move.nb_rrr, move.ra_rrb, move.rra_rb);
	return (move);
}
